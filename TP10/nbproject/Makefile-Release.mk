...
${OBJECTDIR}/maskOff.o: maskOff.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/maskOff.o maskOff.c
...
${OBJECTDIR}/maskToggle.o: maskToggle.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/maskToggle.o maskToggle.c
...
${OBJECTDIR}/Validar_nomain.o: ${OBJECTDIR}/Validar.o Validar.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Validar_nomain.o Validar.c;\
	else  \
...
${OBJECTDIR}/maskOff_nomain.o: ${OBJECTDIR}/maskOff.o maskOff.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/maskOff_nomain.o maskOff.c;\
	else  \
...
${OBJECTDIR}/maskToggle_nomain.o: ${OBJECTDIR}/maskToggle.o maskToggle.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/maskToggle_nomain.o maskToggle.c;\
	else  \
