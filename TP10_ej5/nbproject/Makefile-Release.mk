...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tp10_ej5

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tp10_ej5: ${OBJECTFILES}
...
${OBJECTDIR}/Validar_1.o: Validar_1.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Validar_1.o Validar_1.c

${OBJECTDIR}/bitClr_1.o: bitClr_1.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bitClr_1.o bitClr_1.c

${OBJECTDIR}/bitGet_1.o: bitGet_1.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bitGet_1.o bitGet_1.c

${OBJECTDIR}/bitSet_1.o: bitSet_1.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bitSet_1.o bitSet_1.c
...
${OBJECTDIR}/maskOff_1.o: maskOff_1.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/maskOff_1.o maskOff_1.c

${OBJECTDIR}/maskOn_1.o: maskOn_1.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/maskOn_1.o maskOn_1.c

${OBJECTDIR}/maskToggle_1.o: maskToggle_1.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/maskToggle_1.o maskToggle_1.c
